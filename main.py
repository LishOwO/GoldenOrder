...
class Game:
    ...
    def __init__(self):
        ...
        self.ZOMBIE_DAMAGE_SOUNDS = [pygame.mixer.Sound("src/son/ZombieSound.mp3"),pygame.mixer.Sound("src/son/Zombie.damage.2.mp3"),pygame.mixer.Sound("src/son/Zombie.damage.3.mp3"),]
